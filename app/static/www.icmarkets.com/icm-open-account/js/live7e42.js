...
/***/ (function(module, exports) {
	...
	$(document).ready(function() {
	    ...
	    function registerLive () {
	        ...
	        $('.wp-icm-open-account.live .reg_overlay').fadeIn();
	...
	function startRegistrationLive() {
	    ...
	    $('.wp-icm-open-account.live .reg_overlay').fadeOut();
		...
		function addJointSteps(branch) {
	        ...
	        $('.wp-icm-open-account.live #step_4 .next_btn button.start-trading-button').html($('.reg_form_live_step3_next').text()).attr('type', 'button');
	        $('.wp-icm-open-account.live .register_process_wrap').addClass('with_joint_steps');

	        $('.wp-icm-open-account.live.steps_container .process_line[data-n="5"]').before($('.wp-icm-open-account.live.steps_container .process_line[data-n="1"], .wp-icm-open-account.live.steps_container .process_line[data-n="3"], .wp-icm-open-account.live.steps_container .process_line[data-n="4"]').clone().addClass('joint_steps').removeClass('current, complete'));
	        $('.wp-icm-open-account.live:not(.steps_container) .process_line[data-n="5"]').before($('.wp-icm-open-account.live:not(.steps_container) .process_line[data-n="1"], .wp-icm-open-account.live:not(.steps_container) .process_line[data-n="3"], .wp-icm-open-account.live:not(.steps_container) .process_line[data-n="4"]').clone().addClass('joint_steps').removeClass('current, complete'));

			$('.wp-icm-open-account.live .process_animation').before($('.wp-icm-open-account.live .register_form[data-n="1"],.register_form[data-n="3"],.register_form[data-n="4"]').clone().addClass('joint_steps_form'));
	        ...
	        $('.wp-icm-open-account.live .joint_steps[data-n="4"]').find('.process_line_text').html($('.reg_form_live_joint_declaration').text());
	        $('.wp-icm-open-account.live .joint_steps_form[data-n="1"]').append($('.wp-icm-open-account.live .fields_individual').clone()).append($('.wp-icm-open-account.live .nationality').clone()).append($('.wp-icm-open-account.live .tin').clone()).append($('.wp-icm-open-account.live .reffer_check').clone()).append($('.wp-icm-open-account.live .reffer_id').clone());
	        ...
	        $('.wp-icm-open-account.live #step_7 .next_btn button.start-trading-button').html($('.wp-icm-open-account.live #step_4 .start-trading-button').text()).attr('type', 'submit');
	        $('.wp-icm-open-account.live #step_5 .fields_individual').removeAttr('class style').addClass('new_joint_fields ');
	        $('.wp-icm-open-account.live #step_5 .joint_reffer_id').after($('.wp-icm-open-account.live #step_5 .el_wrap.next_btn'));
	        ...
	        $('.wp-icm-open-account.live #step_5 .next_btn').prepend($('<button type="button" data-to="4" class="btn step-back">BACK</button>'));
	        $('.wp-icm-open-account.live #step_6 .next_btn button.step-back').text('BACK').attr('data-to', '5');
	    ...
	    function removeJointSteps() {
	        ...
	        $('.wp-icm-open-account.live #step_4 .next_btn button.start-trading-button').html($('.wp-icm-open-account.live #step_4 .start-trading-button').text()).attr('type', 'submit');
            $('.wp-icm-open-account.live.steps_container .process_line').each(function(i) {
	            $(this).attr('data-n', i).find('.step_icon').html(`${i} <div data-edit="${i}" class="modify-step"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M497.9 142.1l-46.1 46.1c-4.7 4.7-12.3 4.7-17 0l-111-111c-4.7-4.7-4.7-12.3 0-17l46.1-46.1c18.7-18.7 49.1-18.7 67.9 0l60.1 60.1c18.8 18.7 18.8 49.1 0 67.9zM284.2 99.8L21.6 362.4.4 483.9c-2.9 16.4 11.4 30.6 27.8 27.8l121.5-21.3 262.6-262.6c4.7-4.7 4.7-12.3 0-17l-111-111c-4.8-4.7-12.4-4.7-17.1 0zM124.1 339.9c-5.5-5.5-5.5-14.3 0-19.8l154-154c5.5-5.5 14.3-5.5 19.8 0s5.5 14.3 0 19.8l-154 154c-5.5 5.5-14.3 5.5-19.8 0zM88 424h48v36.3l-64.5 11.3-31.1-31.1L51.7 376H88v48z" data-parsley-id="19"></path></svg></div>`);
            });
            $('.wp-icm-open-account.live:not(.steps_container) .process_line').each(function(i) {
	    ...
	    $('.wp-icm-open-account.live .main_register_wrap ').on('click', '.next_btn button', function(e) {
	        ...
	        if ($('.wp-icm-open-account.live input[id*="mail"]').hasClass('parsley-error')) {
				return false;
	            ...
	            if (curFormId == '1' && window['unsupportedCountries'].indexOf($countriesInput.val()) != -1 || curFormId == '4' && window['unsupportedCountries'].indexOf($joint_countriesInput.val()) != -1) {
	            ...
	            } else if (curFormId == '1' && window['disallowedCountries'].indexOf($countriesInput.val()) != -1 || curFormId == '4' && window['disallowedCountries'].indexOf($joint_countriesInput.val()) != -1) {
	                window['selectedAccountType'] = getSelectedAccountType();
	                sendGaData('step' + curFormId, function() {
	                    var form = serializeForm();
	                    if ($('.wp-icm-open-account.live form').parsley().validate({ group: 'block-' + block })) {
	            ...
	            function continueOk(curForm, curFormId, nextForm, block, _this) {
					...
					if ($(_this).attr('type') == 'submit') {
	                    ...
	                    if (errorFields.length != 0) {
	                        ...
	                        $('.wp-icm-open-account.live .reg_modal_fail, .wp-icm-open-account.live .reg_overlay').fadeIn();
	                        return false;
	                    }
	                    $('.wp-icm-open-account.live .reg_overlay').fadeIn();
	                    window['selectedAccountType'] = getSelectedAccountType();
	                                ...
	                                if (data && data.status == 'success') {
	                                    ...
	                                    if (data.link && data.link != "" && typeof data.link == 'string' && data.link.length > 16) {
	                                        ...
	                                        sendGaData('reg_success', function() {
	                                            ...
	                                            $('.wp-icm-open-account.live .reg_modal_finish, .wp-icm-open-account.live .reg_overlay').fadeIn();
	                                        });
	                                    }
	                    ...
	                    sendGaData('step' + curFormId, function() {
	                        ...
	                        if (curFormId == '4' && ($jointCountriesInput.length || window['selectedAccountType'] == 'joint')) {
	                            // btn = $(_that);
	                            btn.removeAttr('disabled').removeClass('valid_wait');
								mountBranchedControls($('.wp-icm-open-account.live #step_5'), true);
	                        ...
	                        if (curFormId == '5') {
								...
								$('.signup-buttons-header').hide();
								$('#containers-wrap').hide();
								createTradePlatformAndAccountTypeControls('joint', $('#step_6 .trade-platforms'), $('#step_6 .account-types'), $('#joint_branch_id').attr('data-orig'));
								createButtonsInputs($('.wp-icm-open-account.live #step_6 .trade-platforms .select_btn, .wp-icm-open-account.live #step_6 .account-types .select_btn'));
	                            ...
	                            tryHardSelectTradePlatformAndAccountType($('.wp-icm-open-account.live #step_6'), true);
	                        }
							...
							if (curFormId == '1') collectUnsupportedAndDisallowedCountriesLive();
	                        if ((curFormId == '1' && window['unsupportedCountries'].indexOf($countriesInput.val()) != -1 || curFormId == '4' && window['unsupportedCountries'].indexOf($joint_countriesInput.val()) != -1) || (curFormId == '1' && window['disallowedCountries'].indexOf($countriesInput.val()) != -1 || curFormId == '4' && window['disallowedCountries'].indexOf($joint_countriesInput.val()) != -1)) {
	    ...
	    function goToStep(id, forceBack) {
	        ...
	        $('.wp-icm-open-account.live .register_form').fadeOut().removeClass('active_step').find('input').removeAttr('required');
	        $('.wp-icm-open-account.live .register_form[data-n="' + id + '"]').fadeIn()
	    ...
	    function showUnsupportedCountryPopup(countryName, callback_ok, callback_cancel) {
	        ...
	        function cancelHandler(e, callback_cancel) {
	            $('.wp-icm-open-account.live .reg_modal_unsupported_country, .wp-icm-open-account.live .reg_overlay').fadeOut();
	            if (callback_cancel) {
	                callback_cancel();
	            }
	        }
	    ...
	    function showDisallowedCountryPopup(countryName, callback_ok) {
	        ...
	        $('.wp-icm-open-account.live .reg_modal_disallowed_country, .wp-icm-open-account.live .reg_overlay').fadeIn();

	        function okHandler() {
	            $('.wp-icm-open-account.live .reg_modal_disallowed_country, .wp-icm-open-account.live .reg_overlay').fadeOut();
	            if (callback_ok) {
	                callback_ok();
	            }
	        }
	...
	function initCurrenciesList (isJoint) {
		...
		if ($input && $input.length && $list && $list.length) {
			var currenciesList = window.currenciesList;
			var branched = currenciesList.find(function(item) {
				return item && item.branch === window['currentBranch'];
			});
			$list.html('');
			if (branched && branched.items) {
				branched.items = branched.items.filter(x => (isIslamicChecked ? x.islamic : true))
				branched.items.reduce(
					function(parent, item) {
...
function toggleRefferControls (countryCode) {
	...
	if (cysecCountriesString.includes(countryCode)) {
...
function initAddressAutoCompletion(accType) {
	...
	if (!hideCountriesFor.includes(country.value)) {
		...
		selectAddressInput.addEventListener("input", function(e) {
			...
			xhr = $.get(`https://apigateway.icmarkets${Cookies.get('user_want_language') === 'cn' ? "-zhi" : ""}.com/address?country=` + country.value + "&query=" + input + "&token=" + window.jwt).done(function(result) {
				...
				result.forEach(function(address, index) {
					...
					element.onclick = function(e) {
						$.ajax({
							type: "POST",
							url: `https://apigateway.icmarkets${Cookies.get('user_want_language') === 'cn' ? "-zhi" : ""}.com/address/format?token=` + window.jwt,
							dataType: "json",
		...
		manualAddressSelector.addEventListener("click", function(e){
			selectAddressInput.removeAttribute("required");
			removeAddressNotSelectedError();
		});

		autoAddressSelector.addEventListener("click", function(e){
			if (!selectedAddress) {
				addAddressNotSelectedError();
			} else {
